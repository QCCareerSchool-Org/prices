...
export declare function getPrices(connection: PoolConnection, courses: string[] | undefined, countryCode: string, provinceCode?: string, options?: PriceQueryOptions): Promise<PriceResult>;
