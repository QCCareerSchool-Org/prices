...
var DEFAULT_CONNECTION_LIMIT = 100;
var options = {
...
if (typeof process.env.DB_SSL !== 'undefined' && process.env.DB_SSL === 'true') {
    ...
    if (typeof process.env.DB_CLIENT_CERT !== 'undefined') {
        options.ssl.cert = fs_1.default.readFileSync(process.env.DB_CLIENT_CERT);
    }
    if (typeof process.env.DB_CLIENT_KEY !== 'undefined') {
        options.ssl.key = fs_1.default.readFileSync(process.env.DB_CLIENT_KEY);
    }
    if (typeof process.env.DB_SERVER_CA !== 'undefined') {
        options.ssl.ca = fs_1.default.readFileSync(process.env.DB_SERVER_CA);
    }
}
