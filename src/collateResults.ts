...
export const collateResults = (
  ...
  return {
    ...
    plans: {
      ...
      part: courseResults.some(c => typeof c.plans.part === 'undefined') ? undefined : {
        ...
        installments: courseResults.length ? firstResult.plans.part!.installments : 1,
        ...
        originalInstallments: courseResults.length ? firstResult.plans.part!.originalInstallments : 1,
      },
    },
