...
export const promoCodeSpecs: PromoCodeSpec[] = [
  ...
  { code: 'BACK2SCHOOL', student: 'DENIED', schools: [ 'QC Makeup Academy', 'QC Event School', 'QC Design School' ], start: new Date(2021, 7, 16, 9, 30), end: new Date(2021, 7, 27, 8) }, // August 16 at 09:30 to August 27 at 08:00
