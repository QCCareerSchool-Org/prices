...
const studentSupportNames = [ 'NATHAN', 'EMILY', 'HEATHER', 'TAYLOR', 'KAYLA', 'PAMELA', 'SASHA', 'SHANNON', 'SONA', 'VICKY' ];
...
export const promoCodeSpecs: PromoCodeSpec[] = [
  ...
  { code: 'GLOBALLUMINOUS', student: 'DENIED', schools: [ 'QC Makeup Academy' ] },
  ...
  { code: '100OFF', student: 'DENIED', schools: [ 'QC Design School', 'QC Wellness Studies' ] },
  { code: '150OFF', student: 'DENIED', schools: [ 'QC Wellness Studies' ] },
  { code: '200OFF', student: 'DENIED', schools: [ 'QC Pet Studies' ] },
